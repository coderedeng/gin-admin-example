...
// @Router    /v1/menu/getBaseMenuTree [post]
...
// @Router    /v1/menu/addMenuAuthority [post]
func (a *AuthorityMenuApi) AddMenuAuthority(c *gin.Context) {
	...
	if err := menuService.AddMenuAuthority(authorityMenu.Menus, authorityMenu.AuthorityId); err != nil {
		global.GPA_LOG.Error("添加失败!", zap.Error(err))
...
// @Router    /v1/menu/getMenuAuthority [post]
...
// @Router    /v1/menu/addBaseMenu [post]
...
// @Router    /v1/menu/deleteBaseMenu [post]
...
// @Router    /v1/menu/updateBaseMenu [post]
