...
// @Router    /v1/authorityBtn/getAuthorityBtn [post]
func (a *AuthorityBtnApi) GetAuthorityBtn(c *gin.Context) {
	...
	if err != nil {
		global.GPA_LOG.Error("查询失败!", zap.Error(err))
...
// @Router    /v1/authorityBtn/setAuthorityBtn [post]
func (a *AuthorityBtnApi) SetAuthorityBtn(c *gin.Context) {
	...
	if err != nil {
		global.GPA_LOG.Error("分配失败!", zap.Error(err))
...
// @Router    /v1/authorityBtn/canRemoveAuthorityBtn [post]
